...
public class ClienteDAO {
    ...
    public boolean inserir(Cliente cliente) {
        try {
            ...
            String sql 	   = "INSERT INTO " + NOMEDATABELA + " (nomeCliente) VALUES (?);";
            String sql_cpf = "INSERT INTO " + NOMEDATABELA + " (cpfCliente) VALUES (?);";
            String sql_end = "INSERT INTO " + NOMEDATABELA + " (enderecoCliente) VALUES (?);";
            PreparedStatement ps = conn.prepareStatement(sql);
            PreparedStatement pc = conn.prepareStatement(sql_cpf);
            PreparedStatement pe = conn.prepareStatement(sql_end);
            ps.setString(1, cliente.getNomeCliente());
            ps.executeUpdate();
            ps.close();
            pc.setString(1, cliente.getCpfCliente());
            pc.executeUpdate();
            pc.close();
            pe.setString(1, cliente.getEnderecoCliente());
            pe.executeUpdate();
            pe.close();
            conn.close();
            return true;
